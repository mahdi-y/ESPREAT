 ...
 // include '../../../Controller/clientC.php';
  //$clientC = new ClientC();
  //$clientC->showClient($_SESSION['idClient']);
  ...
  <body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    >
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#book-table">Order</a>
          </li>
        </ul>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="profil.php" class="btn btn-primary ml-xl-4">My profil</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <header id="home" class="header">
      <div class="overlay text-white text-center">
        <h1 class="display-2 font-weight-bold my-3">ESPREAT</h1>
          ...
          <div class="row justify-content-center">
            <div class="col-sm-8 py-5 my-5">
              ...
              <p>
                ...
                niveau de cet sujet. Et avec le taux d'admissions qui ne cesse
                de croitre les problèmes ne font qu'empirer. les buvettes sont à
                la base conçues pour hébérger une centaines de personne au
                maximum les voilà submergées par des miliers d'étudiants chaque
                pause. A prendre en compte aussi que cette complication
                s'amplifie l'hiver puisque la majorité des étudiants sont à
                l'intérieur.
              </p>
            </div>
          </div>
    ...
    >
      <div class="">
        <h2 class="section-title mb-5">Order</h2>
        <div class="row mb-5">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card bg-transparent border my-3 my-md-0">
                ...
                <div class="card-body">
                  <h1 class="text-center mb-4">
                    <a href="#" class="badge badge-primary">$12</a>
                  </h1>
          ...
          <div class="row">
            <div class="col-md-4 my-3 my-md-0">
              <div class="card bg-transparent border">
                ...
                <div class="card-body">
                  <h1 class="text-center mb-4">
                    <a href="#" class="badge badge-primary">$15</a>
                  </h1>
            ...
            <div class="col-md-4 my-3 my-md-0">
              <div class="card bg-transparent border">
                ...
                <div class="card-body">
                  <h1 class="text-center mb-4">
                    <a href="#" class="badge badge-primary">$29</a>
                  </h1>
      ...
      <div class="row">
        ...
        <div class="col-md-6 px-5 has-height-lg middle-items">
          ...
          <div class="text-muted">
            <p>
              <span class="ti-location-pin pr-3"></span> 12345 Fake ST NoWhere,
              AB Country
            </p>
